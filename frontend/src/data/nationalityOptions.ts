/**
 * 国籍下拉：value 为 ISO 3166-1 alpha-2，便于入库与对接；label 为常用中文简称。
 * 中国及港澳台置前，其余按中文名称排序。
 */
...
REST.sort((a, b) => a.label.localeCompare(b.label, "zh-Hans-CN"));

export const NATIONALITY_OPTIONS: { value: string; label: string }[] = [...PRIORITY, ...REST];
